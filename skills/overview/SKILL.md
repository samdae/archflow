...
- Do NOT copy sections from architect.md
...
(Only core entities. Link to architect.md for full schema.)
...
(Pick ONE key flow. Link to architect.md for all flows.)
...
| [Architecture](architect.md) | 상세 설계, API 명세, DB 스키마 |
...
❌ API endpoint lists → Link to architect.md
❌ DB schema details → Link to architect.md
❌ Data coverage lists → Link to architect.md
❌ Detailed prerequisites → Link to README or architect.md
...
| [Architecture](architect.md) | API 명세, DB 스키마, 시퀀스 다이어그램 |
